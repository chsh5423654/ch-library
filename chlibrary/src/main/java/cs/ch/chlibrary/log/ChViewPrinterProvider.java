...
import cs.ch.chlibrary.util.DispLayUtil;
...
public class ChViewPrinterProvider {
    ...
    private View genFloatingView() {
        ...
        return this.floatingView = textView;
    }
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DispLayUtil.dp2px(250, rootView.getResources()));
